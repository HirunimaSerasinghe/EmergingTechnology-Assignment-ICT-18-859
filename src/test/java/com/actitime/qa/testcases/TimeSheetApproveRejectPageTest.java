...
public class TimeSheetApproveRejectPageTest extends TestBase {
    ...
    public void validateRejectTimeTest() {
        ...
        softAssertion.assertTrue(timeTrackPage.validateTimeTrackPageTitle(), "Can't find the Time Track section page title");
        softAssertion.assertTrue(timeTrackPage.validateApproveTimeTrackNav(), "Can't find the Approve time track Navigation panel");
        timeTrackPage.clickApproveTimeTrackPanel();


        softAssertion.assertTrue(timeTrackPage.validateApproveTimeTrackPageTitle(), "Can't find the Approve Time Track section page title");
        softAssertion.assertTrue(timeTrackPage.validateApproveTable(), "Can't find the Approve Time Track table");
        softAssertion.assertTrue(timeTrackPage.validateUserNameListCount(), "No users in the table");
